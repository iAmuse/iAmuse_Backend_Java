...
public class PushUtil {
	...
	public static boolean sendPushToApple(String message,List<DeviceRegistration> deviceRegistration, String path)
	{
		...
		for(DeviceRegistration deviceRegistrations:deviceRegistration){
			...
			List<PushedNotification> notifications=	Push.payload(payload,path+"/"+"Push_iAmuse_production.p12", "iAmuse2018", true, deviceRegistrations.getDeviceToken());
			/*List<PushedNotification> notifications=	Push.payload(payload,path+"/"+"Certificate_iAmuse_APNS_Dev.p12", "iamuse2018", false, deviceRegistrations.getDeviceToken());*/
