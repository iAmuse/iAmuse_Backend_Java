...
public class TransactionReceiptVO {
	...
	private String supscriptionPlan;
	...
	public String getSupscriptionPlan() {
		return supscriptionPlan;
	}
	public void setSupscriptionPlan(String supscriptionPlan) {
	...
	public String getNight_phone_a() {
		return night_phone_a;
	}
	public void setNight_phone_a(String night_phone_a) {
		this.night_phone_a = night_phone_a;
	}
