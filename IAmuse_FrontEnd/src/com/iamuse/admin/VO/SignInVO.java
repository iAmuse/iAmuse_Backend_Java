...
public class SignInVO {
	...
	public String toString() {
		return "SignInVO [userId=" + userId + ", username=" + username + ", password=" + password + ", status=" + status
				+ ", emailId=" + emailId + ", subId=" + subId + ", createdDate=" + createdDate + ", updatedDate="
				+ updatedDate + ", contactNumber=" + contactNumber + ", subUpdatedDate=" + subUpdatedDate
				+ ", pageType=" + pageType + ", fovTop=" + fovTop + ", fovBottom=" + fovBottom + ", fovLeft=" + fovLeft
				...
				+ ", otherCountdownDelay=" + otherCountdownDelay + ", EId=" + EId + ", facebookUrl=" + facebookId
				+ ", twitterUrl=" + googleId + ", image=" + image + ", imageFileName=" + imageFileName + ", userType="
				+ userType + ", facebook=" + facebook + ", twitter=" + twitter + ", emailBody=" + emailBody
				+ ", imageX=" + imageX + ", imageY=" + imageY + ", imageHeight=" + imageHeight + ", imageWidth="
				+ imageWidth + ", zoomScale=" + zoomScale + ", save=" + save + ", result=" + result + ", token=" + token
