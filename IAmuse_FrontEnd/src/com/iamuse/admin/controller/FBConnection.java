...
public class FBConnection {
	...
	public static final String FB_APP_ID = "1808066036165782";
	public static final String FB_APP_SECRET = "d3fa5afef556912f37909d3145573717";
	...
	public String display(@RequestParam(value="error_code",required=false)String errorCode,@RequestParam(value="error_message",required=false)String errorMessage,HttpServletRequest request, HttpServletResponse response,ModelMap model,RedirectAttributes redirectAttributes) throws ServletException, IOException
	{
		if(errorCode ==null) {
		...
		BoothAdminLogin userMaster=loginService.setFbDetails(code);
		 if(userMaster !=null){
			 	signInVO.setFacebookId(userMaster.getFacebookId());
			 	signInVO.setGoogleId(userMaster.getGoogleId());
