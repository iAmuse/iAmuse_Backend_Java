...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  renderImage: function renderImage(changed) {
	    ...
	    document.getElementById("imgWidth").value=imageData.width;
	     document.getElementById("imgHeight").value=imageData.height;
	  ...
	  initCropBox: function initCropBox() {
	    ...
	    var h=document.getElementById("h2").value;
	    var cropBoxData;
	    ...
	    if(x.length<=0 || y.length<=0)
	    	...
	    	{
	    cropBoxData.oldLeft = cropBoxData.left = x;
	    cropBoxData.oldTop = cropBoxData.top = y;
	    	}
	  ...
	  renderCropBox: function renderCropBox() {
	    ...
	    var divHeight=document.getElementById('target').offsetHeight;
	     var divWidth=document.getElementById('target').offsetWidth;
	     var imgW=document.getElementById("imgWidth").value;
	     var imgH=document.getElementById("imgHeight").value;
	     var a=(divWidth-imgW)/2;
	     var b=(divHeight-imgH)/2;
	    ...
	    */
	    ...
	    document.getElementById("x").value=cropBoxData.left;
	    document.getElementById("y").value=cropBoxData.top;
	    document.getElementById("w").value=cropBoxData.width;
	    document.getElementById("h2").value=cropBoxData.height;
