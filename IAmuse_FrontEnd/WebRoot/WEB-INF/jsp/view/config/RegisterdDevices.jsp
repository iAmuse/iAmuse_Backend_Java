...
<!-- Popup Div Ends Here -->
			...
			<div class="right-pannel" data-step="1" data-intro="These devices appearing here would be the ones synced together and being used in the ongoing event">
					<a href="getRegisteredDeviceConfig"><button style="float: right;" class="btn btn-green">Refresh</button></a>
					...
					<ul class="nav nav-tabs">
					    ...
					    <li><a data-toggle="tab" href="#">Step 4<br/>Booth Zoom Profile</a></li>
					  </ul>
					...
					<div class="inner-content" style="margin-top:0px;">
						<div class="col-row">
							...
							<a href="boothSetUpByEventConfigFirst"><button style="float: right;margin-top: 10px;" class="btn btn-green">Next</button></a>
						</div>
						</c:if>
						<c:if test="${deviceRegistration.size() == 0}">
