	   ...
	   for(var i = 0; i< checkedValue.length; i++){
	    var div = document.createElement("div"); 
	        ...
	        div.innerHTML = "<img class='img-thumbnail' src='" + checkedValue[i] + "'" +
	                  "title=''/> <a href='javascript:void(0);' id='"+delValue[i]+"' onclick ='rem(this.id);' class='remove_pict' >Delete</a>";
...
padding-top:20%;
		...
		<center style="color: #00a616;"><c:if test="${boothAdminLogin2.planCode==1}">You need to upgrade your subscription to upload custom backgrounds.</c:if></center>
					...
					<div class="inner-content" style="padding:35px;margin-top: 0px;">
						<div class="col-row">
							<form action="event-background.html">
								...
								<!-- <h1 class="heading" style="margin:10px 0px 0px;color:#2363c5; border-color: black;border-top: 3px solid #05a42e">Backgrounds for Event</h1>
...
<button onclick="closeThankYouScreen();" style="float:right;margin-right:10px;" class="btn btn-green">Done</button>
  ...
  <div id="fade" class="black_overlay"></div>
								<form:form action="uploadBackgroundImageConfig" modelAttribute="AdminPictureVO" onsubmit="return validateUpdateForm();" enctype="multipart/form-data" method="post">
								...
								<input type="hidden" value="${boothAdminLogin2.planCode}" id="subid"/>
								<div class="demohide">
								...
								<!-- <div class="upload-bg">
									...
									<div class="clearfix"></div>
									<a href="javascript:void(0)" class="btn btn-green " style="margin:-40px 40px 0px;color:#2363c5;width:38%;font-size: 14px;float: right;" onclick="open1();">Choose Background(s) From Library</a>
								</div> -->
								
								
								<h1 class="heading" style="margin:20px 0px 0px; border-color: black;border-top: 3px solid #05a42e">Customized Event Experience</h1>
								...
								<div class="clearfix"></div>
									...
									<div id="gif" class="pull-right" style="margin: 5px -82px;display:none;">
