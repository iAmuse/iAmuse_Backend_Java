...
<div class="clearfix"></div>
	...
	<!-- <a href="boothSetUpByEventConfig"><button class="btn btn-green pull-right" style="margin-left:10px;">Refresh</button></a> -->
		<a href="getImagePushAdminCurrentConfig"><button class="btn btn-green pull-right" style="margin-left:10px;">Take Calibration Picture</button></a>
		<div class="clearfix"></div>
...
<div class="col-md-5 rgb-textbox">
	...
	<div class="clearfix"></div>
	<a onclick="resetDefault()" class="btn-success btn "  style="margin-left:10px; margin-top:0px; text-decoration:none;width:145px;color:#fff;padding:10px;">Reset Default</a>
	<input type="submit" value="Next" class="btn-success btn" style="width:145px;margin-left:43px;float: right;" onclick="enablebtn();">
