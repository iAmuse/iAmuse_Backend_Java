...
<!-- Popup Div Ends Here -->
    ...
    <div class="clearfix"></div>
            ...
            <input type="text" class="form-control" id="imgHeight" placeholder="imgHeight">
						...
						<form:form action="advanceBoothSetUpByEventConfig" modelAttribute="SignInVO1" onsubmit="return formValidation();" >
						...
						<div class="col-md-5 cropping-section both-section" style="margin-top:35px;min-height:228px;">
							...
							<div class="form_row" >
								...
								<div class="form_element"  style="width:54%"><input type="text" class="text-medium" name="otherIntractionTimout" id="otherIntractionTimout" value="${fovbyuser.otherInstructionTimeout}"></div> <span style="color:red" id="otherIntractionTimoutSpan"></span>
								<div class="clearfix"></div>
							</div>
							<div class="form_row">
								...
								<div class="form_element"  style="width:54%"><input type="text" class="text-medium" name="otherCountdownDelay" id="otherCountdownDelay" value="${fovbyuser.othrtCountDelay}"  ></div> <span style="color:red" id="otherCountdownDelaySpan"></span>
						...
						<div class="clearfix"></div>
						<input type="submit" value="Next" class="btn btn-green" style="width:auto;margin-top:15px;" data-toggle="tooltip" title="You can update and send the RGB values as a push notification the synced devices for the ongoing event"/>
						</div>
						</form:form>
						<div class="clearfix"></div>
					</div>
