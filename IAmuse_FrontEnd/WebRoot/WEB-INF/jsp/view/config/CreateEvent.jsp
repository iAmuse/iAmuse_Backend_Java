...
.form_element{width:32%}
</style>
		<div class="right-pannel">
					<h1 class="heading pull-left" style="margin-bottom:15px;">Create Event</h1>
					<div class="clearfix"></div>
					<div class="inner-content" style="padding:35px;margin-top: 0px;" data-step="2" data-intro="Add basic details of the event to start configuring the event">
						<div class="col-row">
