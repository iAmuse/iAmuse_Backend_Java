...
<style>.right-pannel{height:auto !important;}</style>
		<div class="right-pannel">
					<h1 class="heading pull-left">Create Event</h1>
					<div class="clearfix"></div>
					<div class="inner-content" style="padding:35px;" data-step="2" data-intro="Add basic details of the event to start configuring the event">
						<div class="col-row">
						...
						<div id="effect"  class=""><center><h4 style="color: red;">${errorMessage}</h4></center></div>
							...
							<form:form action="saveSuperAdminEvent" modelAttribute="EventVO" onsubmit="return formValidationSACreateEvent();" method="POST">
								<div class="form_row">
									<div class="form_label">Event Type</div>
									<div class="sort-select" >
										<select name="eventType" style="width:25%;padding:6px;">
								...
								<div class="form_row">
									...
									<div class="form_element"><input type="text" placeholder="Date"  name="eventStart" id="eventStart" readonly="readonly" style="padding: 6px;width:48%;float:left;border:1px solid #c8c8c8"> 
									...
									<span style="color:red" id="eventStartSpan"></span>
									<div class="clearfix"></div>
								</div>
								<div class="form_row">
								...
								<div class="form_row">
									<div class="form_label">Event Host Email</div>
									<div class="form_element"><input type="text" placeholder="Event Host Mailer Id"  name="eventHostMailerId" id="eventHostMailerId"></div> <span style="color:red" id="eventHostMailerIdSpan"></span>
									<div class="clearfix"></div>
								</div>
								...
								<div class="form_row">
									...
									<div class="form_element"><input type="text" placeholder="Twitter"  name="twitter" id="twitter"></div> <span style="color:red" id="twitterSpan"></span>
									<div class="clearfix"></div>
								</div>
								
								<div class="form_row">
									<div class="form_label">Email Body</div>
									<div class="form_element"><textarea placeholder="Email Body"  name="emailBody" id="emailBody"  rows="4" cols="80"></textarea></div> <span style="color:red" id="emailBodySpan"></span>
									<div class="clearfix"></div>
								...
								<div class="form_row" style="margin-top:35px;">
									...
									<div class="form_element"><input type="Submit" value="Save to Continue" class="btn btn-green" data-toggle="tooltip" title="Add basic details of the event to start configuring the event"></div>
									<div class="clearfix"></div>
								</div>
							</form:form>
						</div>
