...
function share_image() {
    ...
    if (checkCount > 0){
      ...
      // alert(ids);
     window.location.href="socialShareSA?userId="+${boothAdminLogin.userId}+"&imageIds="+favorite.join(",");
        return true;
    } else {
...
<div id="gif" style="display: none;">
	<img src="http://www.willmaster.com/images/preload.gif">
		...
		<div class="right-pannel">
					...
					<a href="eventReportDetailsSA?eventId=${optionsReports.eventId }"><button type="button" class="btn btn-default btn-sm pull-left" style="margin-right: 10px;"><span class="glyphicon glyphicon-chevron-left"></span>Back</button></a><h1 class="heading pull-left">Event Gallery</h1>
							...
							<c:forEach items="${emailImagesList}" varStatus="loop" var="igl">
								<div class="gallery-div">
									...
									<a class="fancybox" href="${igl.mailImageUrl}" data-fancybox-group="gallery" title="IAmuse Gallery">
										<img src="${igl.mailImageUrlThumb}" style="text-align:center;left:0;right:0;">
										</a>
										<p class="event-time" style="color:#ffffff;background: rgba(0, 0, 0, 0.17);float:left;">${igl.uploadTime}</p>
