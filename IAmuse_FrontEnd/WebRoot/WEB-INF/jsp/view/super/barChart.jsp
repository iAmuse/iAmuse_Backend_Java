...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
					...
					<div class="inner-content" style="padding:35px;">
						...
						<span class="pull-right chnage-month">
							...
							<%-- <form:select path="year" items="${yearList}" id="years" selected="selected" class="sort-select"/> --%>
							
							<p>Change Year</p>
							<select id="years" name="year" style="width:150px;padding:6px;">
...
$(function () {
    $("#years").change(function () {
      ...
      //  window.location ='getReports?Value='+selectedValue;
		   ...
		   console.log('selectedValue by abhishek \t'+selectedValue);
	  // alert('hi abhishek ');
		 $.ajax({
		        type: "GET",
		        url: "barChart",
		        data: { dateText: selectedValue} ,
		        async:false,
...
function ajaxCallMethod(){
	//alert('hi abhishek inside the bar chart ');
	 $.ajax({
	        type: "GET",
	        url: "barChart",
	        async:false,
