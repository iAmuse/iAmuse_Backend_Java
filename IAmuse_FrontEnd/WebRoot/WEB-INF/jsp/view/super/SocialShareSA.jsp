		...
		<head>
			<meta name="twitter:card" content="photo" />
  			...
  			<meta name="twitter:image" content="<%="http://"+request.getServerName()+ ":" + request.getServerPort()%><%= request.getAttribute("javax.servlet.forward.request_uri")+"?"+request.getQueryString() %>" />
  			<meta name="twitter:url" content="<%="http://"+request.getServerName()+ ":" + request.getServerPort()%>" />
		</head>
		<body>
						...
						<div class="col-row">
							<div class="event-gallery-action">
								...
								<div class="gallery-option" style="width: 12% !important;">
									...
									&nbsp;&nbsp;&nbsp;
									<span class="img-action">
										<a href="https://twitter.com/share" class="twitter-share-button" data-size="large" data-url="<%="http://"+request.getServerName()+ ":" + request.getServerPort()%><%= request.getAttribute("javax.servlet.forward.request_uri")+"?"+request.getQueryString() %>" data-show-count="false">Tweet</a><script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script></html>
									</span>
									<div class="clearfix"></div>
								</div>
								<div class="clearfix"></div>
