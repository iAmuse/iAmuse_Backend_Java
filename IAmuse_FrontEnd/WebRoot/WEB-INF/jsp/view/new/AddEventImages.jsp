...
<div id="gif" style="display: none;">
 ...
 <div id="fade" class="black_overlay"></div>
								<form:form action="addUploadBackgroundImage" modelAttribute="AdminPictureVO" onsubmit="return validateUpdateForm();" enctype="multipart/form-data" method="post" id="fileUploadForm">
