...
<style>.right-pannel{height:auto !important;}.form_element{width:32%}</style>
						...
						<div class="col-row">
							<form:form action="save-create-event.html" modelAttribute="EventVO" onsubmit="return formValidation();">
								...
								<div class="form_row">
									...
									<div class="form_element"><input type="text" placeholder="Twitter"  name="twitter" id="twitter" value="https://twitter.com/iamusebooth"></div> <span style="color:red" id="twitterSpan"></span>
									<div class="clearfix"></div>
								</div>
