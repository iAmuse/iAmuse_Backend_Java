...
<style>
	.right-pannel{height:auto !important}
		...
		<a href="getImagePushAdminCurrentConfig"><button class="btn btn-green pull-right" style="margin-left:10px;">Take Test Picture</button></a> -->
					...
					<p class="subtext">The Zoom Profile of your Booth refers to how close Guests are to the Camera.  If a Guest is close to Camera, only their upper body is visible vs. if they are farther away from Camera, choose Zoomed Out profile.</p>
					<p class="subtext" style="margin-bottom:25px;">The Zoom Profile affects which Backgrounds are available/will look good at your Event, since Backgrounds are setup to only work with a single Zoom Profile.</p>
    ...
    <div class="row">
    			 ...
    			 <div class="col-md-3 docs-toggles" style="text-align:center">
   ...
   <div class="img-crop" >
	...
	<div class="row" id="actions">
										...
										<div class="clearfix"></div>
										<input type="submit" value="Save" name="save" class="btn btn-green " style="width:auto;" >	    							
