	...
	<body id="printableArea">
		...
		<div class="paypal-container">
			...
			<div class="paypal-body">
				...
				<h1 class="greeting-h">You sent a payment of ${transactionReceiptVO.unitPrice} USD to iAmuse (${transactionReceiptVO.sellerEmail})</h1>
				...
				<table class="tabel custome-table" width="100%">
					<thead>
						<tr>
							<th>Description</th>
							<th width="130px" style="text-align:right">Unti Price</th>
					...
					<tbody>
						<tr style="border-bottom:1px solid rgba(150, 150, 150, 0.45);">
							...
							<td align="right">${transactionReceiptVO.unitPrice}.00</td>
