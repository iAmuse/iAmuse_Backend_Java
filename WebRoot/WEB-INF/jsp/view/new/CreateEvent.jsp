 ...
 $(document).ready(function() {
	  $('#effect').delay(9000).fadeOut(400);
       ...
       document.getElementById('form_element').innerHTML = getTimeZone(); */
...
<style>/*.right-pannel{height:auto !important;}*/.form_element{width:30%}</style>
<div class="col-lg-2 col-md-3" style="width:20%;"></div>
		<div class="col-lg-10 col-xs-12 right-pannel">
					<h1 class="headingtitle1 pull-left createEvent-lbl">Create Event<br><span><h4 style="font-size:15px">Customize the details and content that appears in the email sent to your Guests.</h4></span></h1>
					...
					<div class="inner-content col-xs-11" style=" /* padding:35px; */" data-step="2" data-intro="Add basic details of the event to start configuring the event">
						<div class="col-row event-field-row">
							<form:form action="save-create-event.html" modelAttribute="EventVO" onsubmit="return formValidation();">
								...
								<div class="form_row event-field-cls">
									...
									<div class="form_element"><input type="text" placeholder="Hosts Email Address"  name="eventHostMailerId" id="eventHostMailerId" value="${boothAdminLogin.emailId}"></div> <span style="color:red" id="eventHostMailerIdSpan"></span>
									<div class="clearfix"></div>
								</div>
								
								<div class="form_row event-field-cls">
									<div class="form_label" title="This link is included on emails to Guests, use it to promote your Facebook page or event.">Facebook</div>
									<div class="form_element" title="This link is included on emails to Guests, use it to promote your Facebook page or event."><input type="text" placeholder="Facebook"  name="facebook" id="facebook" value="https://www.facebook.com/iamusebooth/" ></div> <span style="color:red" id="facebookSpan"></span>
									<div class="clearfix"></div>
								</div>
								
								<div class="form_row event-field-cls">
									<div class="form_label" title="This link is included on emails to Guests, use it to promote your Twitter feed.">Twitter</div>
									<div class="form_element"  title="This link is included on emails to Guests, use it to promote your Twitter feed."><input type="text" placeholder="Twitter"  name="twitter" id="twitter" value="https://twitter.com/iamusebooth"></div> <span style="color:red" id="twitterSpan"></span>
									<div class="clearfix"></div>
								</div>
								...
								<div class="form_row event-field-cls">
									<div class="form_label" style="line-height:15px;">Enable Phone Number</div>
									<div class="form_element">
								...
								<div class="form_row event-field-cls" style="margin-top:35px; margin-bottom:50px;">
									<div class="form_label">&nbsp;</div>
									<div class="form_element"><input type="Submit" value="Next" class="btn btn-green btn-wid" data-toggle="tooltip" title="Add basic details of the event to start configuring the event"></div>
									<div class="clearfix"></div>
								</div>
							</form:form>
						</div>
